...
(function( $ ){
    ...
    var WorldMap = function(params) {
		...
		$('<div/>').addClass('scsea').html('<img src=js/jvmap/scsea.jpg>').appendTo(params.container);
		$('<div/>').addClass('tuli').html('<img src=js/jvmap/tuli5.png>').appendTo(params.container);
