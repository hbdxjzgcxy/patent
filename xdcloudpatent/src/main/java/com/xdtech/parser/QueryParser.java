...
public class QueryParser extends XDBaseParser implements QueryParserConstants {
	static {
	...
	final public Query TopLevelQuery(String field) throws ParseException, Exception {
		Query q;
		q = Query(field);
		jj_consume_token(0);
		{
	...
	final public Query Query(String field) throws ParseException, Exception {
	...
	final public Query Clause(String field) throws ParseException, Exception {
		Query q;
		...
		if (jj_2_1(2)) {
			...
			case COUNTFUNCTION: {
				fieldToken = jj_consume_token(COUNTFUNCTION);
				op = jj_consume_token(COLON);
				function = true;
		...
		case NUMBER: {
			q = Term(field);
			q = XDTermQueryChange(q, op == null ? "=" : op.image, function);
			break;
		}
		case LPAREN: {
	...
	final public Query Term(String field) throws ParseException, Exception {
	...
	private boolean jj_3R_4() {
		if (jj_scan_token(COUNTFUNCTION))
			return true;
		if (jj_scan_token(COLON))
			return true;
		return false;
	...
	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x17, 0x4, 0x0, 0x0, 0x0, 0x13, 0x10, 0x0, 0x0, 0x0, 0x0, 0x300, 0x20, 0x300, 0xc0, 0x0, 0x0, 0x0, 0x10, };
	}
